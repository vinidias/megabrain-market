...
export class PanelLayoutManager implements AppModule {
  ...
  private getGateAction(reason: PanelGateReason): () => void {
    switch (reason) {
      ...
      case PanelGateReason.FREE_TIER:
        return () => window.open('https://megabrain.market/pro', '_blank', 'noopener,noreferrer');
      default:
        return () => {};
    }
  }
  ...
  async renderLayout(): Promise<void> {
    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header">
        ...
        return `
            <a href="${vHref('full', 'https://megabrain.market/dashboard')}"
            ...
            <a href="${vHref('tech', 'https://tech.megabrain.market')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('finance', 'https://finance.megabrain.market')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('commodity', 'https://commodity.megabrain.market')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('energy', 'https://energy.megabrain.market')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('happy', 'https://happy.megabrain.market')}"
          ...
          <span class="logo">MONITOR</span><span class="logo-mobile">MegaBrain Market</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="https://x.com/eliehabib" target="_blank" rel="noopener" class="credit-link">
            <svg class="x-logo" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            <span class="credit-text">@eliehabib</span>
          </a>
          <a href="https://github.com/vinidias/megabrain-market" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
      ...
      <nav class="mobile-menu" id="mobileMenu">
        ...
        <div class="mobile-menu-footer-links">
          <a href="${this.ctx.isDesktopApp ? 'https://megabrain.market/pro' : 'https://www.megabrain.market/pro'}" target="_blank" rel="noopener">Pro</a>
          <a href="${this.ctx.isDesktopApp ? 'https://megabrain.market/blog/' : 'https://www.megabrain.market/blog/'}" target="_blank" rel="noopener">Blog</a>
          <a href="${this.ctx.isDesktopApp ? 'https://megabrain.market/docs' : 'https://www.megabrain.market/docs'}" target="_blank" rel="noopener">Docs</a>
          <a href="https://status.megabrain.market/" target="_blank" rel="noopener">Status</a>
        </div>
      ...
      <footer class="site-footer">
        ...
        <nav>
          ...
          <a href="${this.ctx.isDesktopApp ? 'https://megabrain.market/docs' : 'https://www.megabrain.market/docs'}" target="_blank" rel="noopener">Docs</a>
          <a href="https://status.megabrain.market/" target="_blank" rel="noopener">Status</a>
          <a href="https://github.com/vinidias/megabrain-market" target="_blank" rel="noopener">GitHub</a>
          <a href="https://discord.gg/re63kWKxaz" target="_blank" rel="noopener">Discord</a>
          <a href="https://x.com/megabrain-marketai" target="_blank" rel="noopener">X</a>
          ${this.ctx.isDesktopApp ? '' : `<span id="footerDownloadMount"></span>`}
        </nav>
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} MegaBrain Market</span>
      </footer>
  ...
  private insertByOrder(grid: HTMLElement, el: HTMLElement, key: string): void {
    ...
    for (let i = idx + 1; i < this.resolvedPanelOrder.length; i++) {
      ...
      // (MEGABRAIN_MARKET-Q6). If the reference moved, fall through to the
