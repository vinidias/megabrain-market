export const CLOUD_SYNC_KEYS = [
  'megabrain-market-panels',
  'megabrain-market-monitors',
  'megabrain-market-layers',
  'megabrain-market-disabled-feeds',
  'megabrain-market-panel-spans',
  'megabrain-market-panel-col-spans',
  'panel-order',
  'panel-order-bottom-set',
  'megabrain-market-theme',
  'megabrain-market-variant',
  'megabrain-market-map-mode',
