...
export const DESKTOP_PARITY_FEATURES: DesktopParityFeature[] = [
  ...
  },
  {
    ...
    apiHandlers: ['server/megabrain-market/conflict/v1/handler.ts', 'server/megabrain-market/infrastructure/v1/handler.ts', 'server/megabrain-market/cyber/v1/handler.ts', 'server/megabrain-market/maritime/v1/handler.ts', 'server/megabrain-market/military/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/megabrain-market/news/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/megabrain-market/market/v1/handler.ts'],
    locality: 'fully-local',
  ...
  },
  {
    ...
    apiHandlers: ['server/megabrain-market/military/v1/handler.ts'],
    locality: 'api-key',
