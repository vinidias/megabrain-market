...
export const shareTexts = {
  twitter: (data: StoryData) =>
    ...
    `\nGenerated by @MegaBrainMarketApp`,
  ...
  linkedin: (data: StoryData) =>
    ...
    `\nData via MegaBrain Market - Open source geopolitical intelligence`,
...
export function getShareUrls(data: StoryData): Record<string, string> {
  ...
  return {
    ...
    reddit: `https://reddit.com/submit?url=${encodeURIComponent(url)}&title=${encodeURIComponent(`${data.countryName} Intelligence Brief - MegaBrain Market`)}`,
