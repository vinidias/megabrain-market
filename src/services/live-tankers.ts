...
//
// The handler-side cache (server/megabrain-market/maritime/v1/get-vessel-snapshot.ts)
...
import type { SnapshotCandidateReport } from '@/generated/client/megabrain-market/maritime/v1/service_client';
