...
// VITE_VARIANT=tech → tech.megabrain.market (tech-focused)
// VITE_VARIANT=full → megabrain.market (geopolitical)
// VITE_VARIANT=finance → finance.megabrain.market (markets/trading)
