...
export const PORTS: Port[] = [
  ...
  { id: 'pecem', name: 'Porto do Pecém (CIPP)', lat: -3.53, lon: -38.81, country: 'Brazil', type: 'mixed', note: 'Ceará industrial port complex. Green hydrogen hub. Wind energy export terminal. Steel & renewable energy corridor.' },
  { id: 'mucuripe', name: 'Porto de Fortaleza (Mucuripe)', lat: -3.71, lon: -38.48, country: 'Brazil', type: 'mixed', note: 'Ceará capital port. Fishing fleet, fuel imports, container commerce. Northeast Brazil trade hub.' },
  { id: 'itaqui', name: 'Porto do Itaqui', lat: -2.57, lon: -44.36, country: 'Brazil', type: 'bulk', note: 'São Luís/Maranhão. Iron ore (Vale/Carajás corridor), grain exports. Deepwater port.' },
  { id: 'suape', name: 'Porto de Suape', lat: -8.39, lon: -35.00, country: 'Brazil', type: 'mixed', note: 'Pernambuco industrial complex. NE Brazil container hub. Petrochemical & shipyard.' },
