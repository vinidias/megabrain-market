...
(proto `megabrain-market.intelligence.v1.GetRiskScoresResponse`).

These weights are **editorial** — authored by the MegaBrainMarket intelligence
...
> version ([#4200](https://github.com/vinidias/megabrain-market/issues/4200)), and
...
> [#3789](https://github.com/vinidias/megabrain-market/issues/3789) by keeping the
...
> `server/megabrain-market/intelligence/v1/_risk-config.ts`, an update to this
...
`server/megabrain-market/intelligence/v1/get-risk-scores.ts`. Each `CiiScore`
therefore exposes:
...
[`shared/cii-weights.ts`](https://github.com/vinidias/megabrain-market/blob/main/shared/cii-weights.ts); server and frontend
