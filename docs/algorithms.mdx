...
description: "Detailed reference for MegaBrain Market scoring formulas, detection algorithms, and classification pipelines used across every intelligence module."
---
