...
description: "MegaBrain Market licensing terms — AGPL-3.0-only source license, optional commercial licensing, and the separate trademark and branding policy."
---

MegaBrain Market source code is licensed under the [GNU Affero General Public License v3.0 (AGPL-3.0-only)](https://www.gnu.org/licenses/agpl-3.0.html).

This page is a plain-language summary for contributors and users. It is not legal advice and does not replace the license text in [`LICENSE`](https://github.com/vinidias/megabrain-market/blob/main/LICENSE).

**Exception — official client packages are MIT.** The thin API clients — the [`megabrain-market` npm CLI](https://www.npmjs.com/package/megabrain-market) (`cli/`), and the [Python](https://pypi.org/project/megabrain-market-sdk/) (`sdk/python/`), [Ruby](https://rubygems.org/gems/megabrain-market) (`sdk/ruby/`), and [Go](https://pkg.go.dev/github.com/vinidias/megabrain-market/sdk/go) (`sdk/go/`) SDKs — are licensed under MIT (see the `LICENSE` file in each directory) so they can be embedded in any application without copyleft obligations. This exception covers only those client packages: the MegaBrain Market platform, server, and dashboard remain AGPL-3.0-only.
...
- use MegaBrain Market for personal, educational, research, nonprofit, or commercial purposes
...
- combine MegaBrain Market code into proprietary products in ways the AGPL would not permit
...
Contact the maintainer through the [GitHub repository](https://github.com/vinidias/megabrain-market) to discuss commercial licensing.

## Trademark and branding

The AGPL covers copyright permissions for the code. It does not grant rights to use the MegaBrain Market name, logo, visual identity, or official project branding.
...
**Using MegaBrain Market's public API in your own tool**: API terms of service may apply separately from the source-code license.
