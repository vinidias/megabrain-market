...
MegaBrain Market runs six thematic variants from a single codebase, each tailored to a different audience:

| Variant | Domain | Focus |
|---------|--------|-------|
| **MegaBrain Market** | megabrain.market | Geopolitics, military, conflicts, infrastructure |
| **Tech Monitor** | tech.megabrain.market | AI/ML, startups, cybersecurity, tech ecosystems |
| **Finance Monitor** | finance.megabrain.market | Markets, central banks, Gulf FDI, commodities |
| **Commodity Monitor** | commodity.megabrain.market | Mining, metals, energy, critical minerals |
| **Happy Monitor** | happy.megabrain.market | Good news, conservation, positive global trends |
| **Energy Monitor** | energy.megabrain.market | Energy security, oil and gas, chokepoints, policy response |

### AI Intelligence Layer

MegaBrain Market uses a multi-tier AI pipeline to process and summarize information:
...
MegaBrain Market aggregates publicly available data from dozens of sources. No proprietary or classified information is used. Key source categories:
...
MegaBrain Market serves several audiences:
...
| Feature | MegaBrain Market | Traditional OSINT Tools | News Aggregators |
|---------|--------------|------------------------|-----------------|
...
- **Web**: Available at megabrain.market and variant subdomains
...
MegaBrain Market is actively developed with planned expansions across several areas:
...
- **API and MCP access** for developers and organizations to integrate MegaBrain Market data into their own tools
...
**Q: Where does MegaBrain Market get its data?**
...
**Q: Does MegaBrain Market track users or sell data?**
...
A: Yes. MegaBrain Market is licensed under AGPL-3.0, meaning anyone can inspect, audit, modify, and redistribute the code. If you run a modified version as a service, you must share your modifications under the same license.

**Q: Who built this?**
A: MegaBrain Market was created by Elie Habib. It is an independent project, not affiliated with any government, intelligence agency, or defense contractor.

**Q: Can I embed MegaBrain Market or use its data in my reporting?**
A: The web interface can be referenced and linked in reporting. For data integration, use the documented REST API, OpenAPI specs, or MCP server. Please attribute "MegaBrain Market (megabrain.market)" when referencing the platform in published work.

**Q: How is this different from Janes, Palantir, or Dataminr?**
A: Those are enterprise products costing tens to hundreds of thousands of dollars per year, typically sold to governments and large corporations. MegaBrain Market aims to democratize access to situational awareness by aggregating public data and using AI to make it digestible. It is open source, free to use, and designed for individual analysts and small teams, not just large organizations.
...
A: MegaBrain Market is primarily a solo project by its creator, with occasional open-source contributions from the community.
...
- **GitHub**: github.com/vinidias/megabrain-market
- **Website**: megabrain.market

---

*This document was last updated March 2026. MegaBrain Market is an independent, open-source project licensed under AGPL-3.0.*
