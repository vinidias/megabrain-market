...
description: "MegaBrain Market platform variants, capabilities, and specialized monitoring configurations for geopolitical and technology intelligence."
---
MegaBrain Market runs six specialized variants from a single codebase, each optimized for different monitoring needs.
...
| **😊 Happy Monitor** | [happy.megabrain.market](https://happy.megabrain.market) | Curated positive news, global progress tracking, science breakthroughs, conservation wins |
| **💰 Finance Monitor** | [finance.megabrain.market](https://finance.megabrain.market) | Global markets, stock exchanges, central banks, commodities, forex, crypto, economic indicators |
| **⛏️ Commodity Monitor** | [commodity.megabrain.market](https://commodity.megabrain.market) | Commodity markets, mining sites, processing plants, supply chains, trade flows |
| **⚡ Energy Monitor** | [energy.megabrain.market](https://energy.megabrain.market) | Oil & gas pipelines, storage facilities, tanker positions, chokepoints, energy infrastructure and shocks |
...
The finance variant ([finance.megabrain.market](https://finance.megabrain.market)) provides specialized layers for global financial markets and economic intelligence.
...
The commodity variant ([commodity.megabrain.market](https://commodity.megabrain.market)) focuses on mining, metals, energy commodities, and critical mineral supply chains.
...
The happy variant ([happy.megabrain.market](https://happy.megabrain.market)) curates positive news, human progress data, and uplifting stories.
