---
title: "Quickstart"
description: "Make your first MegaBrain Market API call in under a minute with copy-paste examples in curl, JavaScript, and Python — includes auth and response format."
---
