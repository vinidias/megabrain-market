...
description: "Reproducible local packaging steps for both desktop variants — full (MegaBrain Market) and tech (Tech Monitor) — including signing and notarization."
---
