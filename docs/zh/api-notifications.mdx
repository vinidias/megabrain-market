---
title: "通知与集成"
description: "MegaBrain Market 通知系统 API 完整参考：涵盖通知渠道注册与管理、webhook 投递重试机制、用户订阅偏好设置，以及 Telegram、Slack、Discord 与 YouTube 等第三方集成端点，让实时警报能够精准推送至团队协作工具、社区频道与个人移动设备。"
---
