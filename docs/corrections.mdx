...
MegaBrainMarket's Energy Atlas publishes evidence bundles — not opinions —
...
- **Evidence bundles on every asset.** Click any pipeline, storage
  facility, or shortage pin on the [Energy Atlas](https://energy.megabrain.market)
...
- An automated correction-intake pipeline. If you spot something
  ...
  [megabrain.market](https://megabrain.market) or open a GitHub issue
  at the [public repository](https://github.com/vinidias/megabrain-market/issues).
