...
If you discover a security vulnerability in MegaBrain Market, please report it responsibly:

1. **GitHub Private Vulnerability Reporting**: Use [GitHub's private vulnerability reporting](https://github.com/vinidias/megabrain-market/security/advisories/new) to submit your report directly through the repository.
...
MegaBrain Market is a client-side intelligence dashboard that aggregates publicly available data. Here are the key security areas:
...
- MegaBrain Market aggregates publicly available OSINT data
...
- Vulnerabilities in the MegaBrain Market codebase
...
Thank you for helping keep MegaBrain Market and its users safe! 🔒
