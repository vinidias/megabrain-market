...
// 401 for s-maxage, poisoning a POP). Send X-MegaBrainMarket-Key when configured;
...
// present in Vercel's MEGABRAIN_MARKET_VALID_KEYS. Same pattern as ais-relay.cjs.
