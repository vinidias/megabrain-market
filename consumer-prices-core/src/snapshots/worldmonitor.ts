/**
 * Builds compact MegaBrainMarket-ready snapshot payloads from computed indices.
 * All types are shaped to match the proto-generated TypeScript interfaces so
 * snapshots can be written to Redis and read directly by MegaBrainMarket handlers.
 */
